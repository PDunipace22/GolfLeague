...
namespace GolfLeagueApp.Controllers
{
    public class PlayersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "PlayerID,PlayerName,Phone,InitialHandicap,LeagueID")] Player player)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PlayerID,PlayerName,Phone,InitialHandicap,LeagueID")] Player player)
        {
            if (ModelState.IsValid)
            {
